...
function modalListen() {
  $('#modal-confirm-delete').on('show.bs.modal', function (event) {
    ...
    $('#modal-form-delete').attr('action', "/".concat(button.data('entity'), "/").concat(button.data('entity-id')));
  });
}
/**
...
module.exports = __webpack_require__(/*! /home/dev4ndy/my-company/resources/js/company.js */"./resources/js/company.js");
